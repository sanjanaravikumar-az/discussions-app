...
export const data = defineData({
    migratedAmplifyGen1DynamoDbTableMappings: [{
            ...
            modelNameToTableNameMapping: { Topic: "Topic-hvtlgvfzqzarni66t3zzkeos4y-main", Post: "Post-hvtlgvfzqzarni66t3zzkeos4y-main", Comment: "Comment-hvtlgvfzqzarni66t3zzkeos4y-main" }
        }],
    authorizationModes: {
